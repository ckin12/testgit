    ...
    return (
        <LinearGradient colors={["#f9f9f9", "#e6e6e6"]} style={styles.container}>
            ...
            <View style={styles.avatarContainer}>
                <Image
                    source={{ uri: "https://static.wikia.nocookie.net/kpop/images/1/17/Aespa_2025_SMTOWN_The_Culture%2C_The_Future_group_concept_photo_1.png/revision/latest?cb=20250116231254" }} // Ảnh đại diện mẫu
                    style={styles.avatar}
                />
            </View>

            {/* Thông tin người dùng */}
            <Text style={styles.name}>Nguyễn Hoài Phúc</Text>
            <Text style={styles.email}>phucnhpd10661@gmail.com</Text>
